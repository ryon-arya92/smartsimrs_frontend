...
//Special Pages
import Igd from "../views/smartremun/igd";
import PasienIgd from "../views/smartremun/pasien/pasienigd";
import Rajal from "../views/smartremun/rajal";
import PasienRajal from "../views/smartremun/pasien/pasienrajal";
import Ranap from "../views/smartremun/ranap";
import PasienRanap from "../views/smartremun/pasien/pasienranap";
...
import Transaksi from "../views/smartremun/transaksi";

// Tambahkan route lain sesuai kebutuhanmu...
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "smartremun/igd", element: <Igd /> },
          { path: "smartremun/pasien/pasienigd", element: <PasienIgd /> },
          
          { path: "smartremun/rajal", element: <Rajal /> },
          { path: "smartremun/pasien/pasienrajal", element: <PasienRajal /> },
          
          { path: "smartremun/ranap", element: <Ranap /> },
          { path: "smartremun/pasien/pasienranap", element: <PasienRanap /> },

          { path: "smartremun/transaksi/:id", element: <Transaksi /> },
          {
